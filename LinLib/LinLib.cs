...
public class LinLib
{
    ...
    public void DumpDirectory(string input, string output, int game)
    {
    ...
    public void BatchDecompileDirectory(string input, string output, int game)
    {
    ...
    public void BatchCompileDirectory(string input, string output, int game)
    {
    ...
    public void DecompileLin(string input, string output, int game)
    {
    ...
    public void CompileLin(string input, string output, int game)
    {
