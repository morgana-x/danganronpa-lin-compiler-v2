...
public class TrialCameraOpcodeDr2 : Opcode
{
    internal TrialCameraOpcodeDr2(string? name, int numargs) : base(name, numargs)
    {
    }

    internal TrialCameraOpcodeDr2(string? name, IEnumerable<int> argSizes) : base(name, argSizes)
    {
    }
